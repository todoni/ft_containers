...
public:
    ...
    typedef std::allocator<Value>::pointer pointer;
    typedef std::allocator<Value>::reference reference;
    typedef std::allocator<Value>::const_reference const_reference;
    typedef std::allocator<rb_tree_node> rb_tree_node_allocator_type;
    typedef std::allocator<rb_tree_node>::pointer link_type;
    typedef std::allocator<rb_tree_node>::size_type size_type;
    typedef std::allocator<rb_tree_node>::difference_type difference_type;
protected:
...
public:
    typedef std::allocator<rb_tree_node_buffer> buffer_allocator_type;
    typedef std::allocator<rb_tree_node_buffer>::pointer buffer_pointer;     
protected:
